import apiWorker from "@/src/api/ApiWorker";
...
interface EmployeeState {
  ...
  loading: boolean;
  error: string | null;
  currentEmployee: Employee | null; // Adicionando para o estado do funcionário atual
}
...
const initialState: EmployeeState = {
  ...
  loading: false,
  error: null,
  currentEmployee: null, // Inicializa como null
};
